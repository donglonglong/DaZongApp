...
<form id="mainForm" method="post" action="${basePath}/dic/add" enctype="multipart/form-data">
    ...
    <div class="right">
        <div class="current">当前位置：<a href="${basePath}/dic/add">内容管理</a> &gt; 广告管理</div>
        <div class="rightCont">
            <p class="g_title fix">新增城市</p>
            <table class="tab1" width="100%">
                <tbody>
                <tr>
                    <td align="right" width="10%">城市<font color="red">*</font>：</td>
                    <td width="30%">
                        <input id="title" name="name" class="allInput" style="width:100%;" type="text"/>
                    </td>
                    <td align="right" width="10%">等级<font color="red">*</font>：</td>
                    <td width="30%">
