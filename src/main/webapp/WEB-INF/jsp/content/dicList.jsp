...
<form action="${basePath}/ad/search" id="mainForm" method="post">
    ...
    <div class="right">
        <div class="current">当前位置：<a href="${basePath}/ad/initList">内容管理</a> &gt;地区管理</div>
        <div class="rightCont">
            ...
            <table class="tab1">
                ...
                <tr>
                    ...
                    <td style="text-align: right;" width="150">
                        ...
                        <input class="tabSub" value="添加" onclick="location.href='${basePath}/dic/toadd'" type="button"/>
                    </td>
                </tr>
                </tbody>
            </table>
                ...
                <table class="tab2" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="${basePath}/ad/modifyInit?name=${list.name}" >修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
                             <a href="${basePath}/ad/remove?name=${list.name}">删除</a>
                        </td>
                    </tr>
                    </c:forEach>
                    </tbody>
