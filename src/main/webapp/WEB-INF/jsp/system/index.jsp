		                ...
		                <td class="leftTd" style="vertical-align:top" width="150">
		                    <div class="left">
		                        <div class="ileft" id="menuDiv">
		                        	<h3 onclick="$('#mainPage').attr('src','${basePath}/ad/initList');"><a>广告列表</a></h3>
		                        	<h3 onclick="$('#mainPage').attr('src','${basePath}/ad/addInit');"><a>添加广告</a></h3>
									<h3 onclick="$('#mainPage').attr('src','${basePath}/businesses');"><a>店铺列表</a></h3>
									<h3 onclick="$('#mainPage').attr('src','${basePath}/dic/list');"><a>查询城市</a></h3>
									<h3 onclick="$('#mainPage').attr('src','${basePath}/user/list');"><a>用户信息</a></h3>
